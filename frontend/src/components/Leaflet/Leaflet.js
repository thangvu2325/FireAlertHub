import { Marker, MapContainer, TileLayer, useMapEvents, Popup, LayersControl } from 'react-leaflet';
...
import { mapRoutingMachineSelector } from '~/redux/selectors';
    ...
    return (
        <div className="wrap">
            ...
            >
                ...
                <RoutingControl
                    position={'topright'}
                    start={mapRoutingMachine.start}
                    end={mapRoutingMachine.end}
                    color={'#757de8'}
                />
